...
const groups = [
  {
    ...
    items: [
      { q: "Do I need to be a member?", a: "No, visitors are always welcome. Just book a bay online and turn up. Pay-as-you-go rates are $30/hr off-peak and $40/hr peak, per bay for up to 4 players." },
