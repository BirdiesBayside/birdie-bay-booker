...
// Build branded email wrapper (fallback if no custom template)
const buildDefaultTemplate = (firstName: string) => {
  return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%;">
          ...
          <tr>
            <td style="background-color:#FFF5E4; padding:26px 22px; border-left:1px solid rgba(31,76,37,0.12); border-right:1px solid rgba(31,76,37,0.12);">
              ...
              <p style="margin:0 0 18px; font-family:Inter, Arial, sans-serif; font-size:16px; line-height:1.6; color:#1F4C25; text-align:center;">Hi ${firstName}, your membership at Birdies has been placed on hold.</p>
